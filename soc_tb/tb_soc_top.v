...
module tb_soc_top;
    ...
    initial begin
        ...
        cpu_write(FACT_CTRL_ADDR, 32'h00000001);
        ...
        cpu_write(32'h00000010, 32'h11111111);
        cpu_write(GPIO_OUT_ADDR, 32'h22222222);
        cpu_write(FACT_N_ADDR, 32'h00000003);
        ...
        cpu_read(32'h00005000, read_data);
